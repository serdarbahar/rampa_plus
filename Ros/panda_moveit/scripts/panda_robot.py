...
class Panda:
    def __init__(self):
        ...
        print("i.e. command: roslaunch panda_moveit_config moveit_planning_execution.launch")
    ...
    def table_pose(self):
        angles = np.array([-0.0095, -1.8569, -1.3694, -1.4878, 1.5183, -2.3095, 0])    # PLACEHOLDER: 0
