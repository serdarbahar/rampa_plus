...
class Panda:
    def __init__(self, rate=100):
        ...
        # Revolute type joints list
        self.joint_names = [ "panda_joint1","panda_joint2", "panda_joint3", "panda_joint4", "panda_joint5", "panda_joint6", "panda_joint7"]
        # Franka Emika Panda has 7 revolute type joints, 1 fixed joint, 2 prismatic joints
    ...
    def table_pose(self, time_from_start=5, blocking=True):
        angles = np.array([-0.0095, -1.8569, -1.3694, -1.4878, 1.5183, -2.3095, 0.0]) # PLACEHOLDER : 0
        self.set_joint_position(angles, time_from_start, blocking)

    def zero_pose(self, time_from_start=5, blocking=True):
        angles = np.radians([0, -90, 0, -90, 0, 0, 0])                              # PLACEHOLDER : 0
        self.set_joint_position(angles, time_from_start, blocking)
