...
from panda_mover.srv import StateService, StateServiceRequest, StateServiceResponse
from panda_mover.srv import ExecutionService, ExecutionServiceRequest, ExecutionServiceResponse
from panda_mover.srv import DiscardService, DiscardServiceRequest, DiscardServiceResponse

from sensor_msgs.msg import JointState
from geometry_msgs.msg import Pose, WrenchStamped, Transform
from Ros.catkin_ws.src.panda_mover.scripts.panda_interface import Panda
...
def return_joint_state(req):
    ...
    try:
        ...
        if len(current_joint_angles) < 7: # Changed from 6 (UR10) to 7 (Panda)
...
rospy.init_node('panda_mover_server')
robot = Panda()
