...
"""autogenerated by genpy from panda_mover/GetTrainingDataServiceRequest.msg. Do not edit."""
import codecs
import sys
...
class GetTrainingDataServiceRequest(genpy.Message):
  ...
  _type = "panda_mover/GetTrainingDataServiceRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from panda_mover/GetTrainingDataServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetTrainingDataServiceResponse(genpy.Message):
  ...
  _type = "panda_mover/GetTrainingDataServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """panda_mover/ListOfPoses[] trajectoryList
...
"""
  ...
  _slot_types = ['panda_mover/ListOfPoses[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = panda_mover.msg.ListOfPoses()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.pose_list = []
...
class GetTrainingDataService(object):
  _type          = 'panda_mover/GetTrainingDataService'
