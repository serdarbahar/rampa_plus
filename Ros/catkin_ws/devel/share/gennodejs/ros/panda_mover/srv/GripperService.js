...
class GripperServiceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GripperServiceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GripperServiceRequest
    let len;
    let data = new GripperServiceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperServiceRequest(null);
...
class GripperServiceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GripperServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GripperServiceResponse
    let len;
    let data = new GripperServiceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperServiceResponse(null);
