...
(cl:defmethod cl:initialize-instance :after ((m <PlannerService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlannerService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mover-srv:<PlannerService-request> is deprecated: use panda_mover-srv:PlannerService-request instead.")))
...
(cl:defmethod request_type-val ((m <PlannerService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:request_type-val is deprecated.  Use panda_mover-srv:request_type instead.")
  (request_type m))

(cl:ensure-generic-function 'joints_input-val :lambda-list '(m))
(cl:defmethod joints_input-val ((m <PlannerService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:joints_input-val is deprecated.  Use panda_mover-srv:joints_input instead.")
  (joints_input m))

(cl:ensure-generic-function 'pose_list-val :lambda-list '(m))
(cl:defmethod pose_list-val ((m <PlannerService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:pose_list-val is deprecated.  Use panda_mover-srv:pose_list instead.")
  (pose_list m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlannerService-request>)))
  ...
  "panda_mover/PlannerServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlannerService-request)))
  "Returns string type for a service object of type 'PlannerService-request"
  "panda_mover/PlannerServiceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PlannerService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlannerService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mover-srv:<PlannerService-response> is deprecated: use panda_mover-srv:PlannerService-response instead.")))
...
(cl:defmethod trajectories-val ((m <PlannerService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:trajectories-val is deprecated.  Use panda_mover-srv:trajectories instead.")
  (trajectories m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlannerService-response>)))
  ...
  "panda_mover/PlannerServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlannerService-response)))
  "Returns string type for a service object of type 'PlannerService-response"
  "panda_mover/PlannerServiceResponse")
