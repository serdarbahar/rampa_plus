...
(cl:defmethod cl:initialize-instance :after ((m <SampleService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SampleService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mover-srv:<SampleService-request> is deprecated: use panda_mover-srv:SampleService-request instead.")))
...
(cl:defmethod condition_poses-val ((m <SampleService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:condition_poses-val is deprecated.  Use panda_mover-srv:condition_poses instead.")
  (condition_poses m))

(cl:ensure-generic-function 'context-val :lambda-list '(m))
(cl:defmethod context-val ((m <SampleService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:context-val is deprecated.  Use panda_mover-srv:context instead.")
  (context m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SampleService-request>)))
  ...
  "panda_mover/SampleServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SampleService-request)))
  "Returns string type for a service object of type 'SampleService-request"
  "panda_mover/SampleServiceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SampleService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SampleService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mover-srv:<SampleService-response> is deprecated: use panda_mover-srv:SampleService-response instead.")))
...
(cl:defmethod sampled_trajectory-val ((m <SampleService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-srv:sampled_trajectory-val is deprecated.  Use panda_mover-srv:sampled_trajectory instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SampleService-response>)))
  ...
  "panda_mover/SampleServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SampleService-response)))
  "Returns string type for a service object of type 'SampleService-response"
  "panda_mover/SampleServiceResponse")
