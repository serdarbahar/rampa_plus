...
(cl:defmethod cl:initialize-instance :after ((m <ListOfPoses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListOfPoses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mover-msg:<ListOfPoses> is deprecated: use panda_mover-msg:ListOfPoses instead.")))

(cl:ensure-generic-function 'pose_list-val :lambda-list '(m))
(cl:defmethod pose_list-val ((m <ListOfPoses>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mover-msg:pose_list-val is deprecated.  Use panda_mover-msg:pose_list instead.")
  (pose_list m))
